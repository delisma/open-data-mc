...
$(document).ready(function() {
	...
	var state = {
		...
		fr: {
			...
			sep: " ",
			aRegion: "National",
			sector: ["Secteur des aliments au dÃ©talil", "Secteur pÃ©trolier au dÃ©tail"],					
			compliance: "DonnÃ©es de conformitÃ©",
			tradeDesc: {
				"Aliments au dÃ©tail": "Le secteur des aliments au dÃ©tail comprend la vente d'aliments dans les Ã©piceries, les marchÃ©s, les magasins spÃ©cialisÃ©s, les dÃ©taillants de cafÃ©, les charcuteries et les boucheries. Les appareils de mesures les plus courants dans ce secteur sont des balances.",
				"PÃ©trolier au dÃ©tail": "Le secteur pÃ©trolier au dÃ©tail comprend la vente de produits du pÃ©trole raffinÃ© liquide (e.g. essence, diesel, propane) et les carburants de remplacement liquides (e.g. hydrogÃ¨ne, Ã©thanol) dans les stations-service, marinas, stations de ravitaillement pour camion, etc.  Les appareils de mesures les plus courants dans ce secteur sont les pompes Ã  carburant et les compteurs de propane."
				},
			bDesc: "mesurant avec prÃ©cision",
			yDesc: "mesurant de faÃ§on imprÃ©Ã§ise",
			errMsg: "Aucune inspection a Ã©tÃ© effectuÃ©e en "
			},
		chartH2: "",
		chartH3: "",
		wbtablesCaption: "",
	...
	var initUI = function() {
		"use strict";
		$("#chart-ui").html(render(state)).append(state.pieChart);
		$trade = $("#dt_trade");
		$year = $("#dt_year");
		$region = $("#dt_province");
